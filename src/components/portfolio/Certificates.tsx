  ...
  return (
    <section id="certifications" className="py-24 lg:py-32 bg-slate-50 dark:bg-slate-950/50 relative overflow-hidden transition-colors duration-300 border-t border-royal/10 dark:border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 xl:px-20 relative z-10">
        ...
        >
          <div className="inline-flex items-center justify-center gap-2 px-4 py-1.5 rounded-full bg-navy/5 text-navy dark:bg-gold/10 dark:text-gold text-[10px] font-black uppercase tracking-widest mb-6 border border-navy/10 dark:border-gold/20 backdrop-blur-sm shadow-sm">
            <Award className="h-3 w-3 text-royal dark:text-gold" /> Continuous Learning
          </div>
                ...
                >
                  ...
                  <div className="p-5 flex flex-col flex-1 bg-white dark:bg-slate-900">
                    <div className="flex items-center gap-1.5 mb-2.5">
                      <Award className="h-3.5 w-3.5 text-royal dark:text-gold" />
      ...
      {/* Dialog Modal for Certificate Details */}
